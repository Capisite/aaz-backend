package com.backend.aaz.config.security;
...
import com.backend.aaz.modules.auth.SecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/categories/**").hasAuthority("MANAGER")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/categories/**").hasAuthority("MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/categories/**").hasAuthority("MANAGER")
